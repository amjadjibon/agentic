...
from agentic.agents.debate.left import create_left_agent
from agentic.agents.debate.right import create_right_agent
from agentic.agents.debate.judge import create_judge_agent
